	...
	<div class="form-group">
		...
		if(!empty($P)){
			...
			if($P=='stud_mgmt_pg'){
				...
				echo '<select name="NewClassID" class="form-control" required>'; // Open
		...
		<div class="col-sm-3">
			<input type="submit" value="Assign Class" name="ANewClass" id="ANewClass" class="btn btn-primary btn-md submit">
		</div>
