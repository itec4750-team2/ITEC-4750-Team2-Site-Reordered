			...
			<div class="col-md-5">
				<form action="#" method="post" name='reqPassForm' class="form-horizontal">
					...
					<div class="form-group">
						...
						<div class="col-sm-8">
						<input type="email" name="Email" id="Email" class="form-control" placeholder= "Enter Email." <?php if(!empty($_GET['stid'])){echo 'value="'.$Email .'"';} ?> required>
						</div>
					</div>
					<!-- Submit form  -->
					<div class="form-group">
						<div class="col-sm-offset-2 col-sm-9">
							<input type="submit" name='reqPass' value='Request Reset' class="btn btn-primary btn-lg submitMain">
						</div>
					</div>
